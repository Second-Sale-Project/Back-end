...
class DatasetHandler(object):
    ...
    def load_product(self, db_settings):
        ...
        with conn.cursor() as cursor:
            ...
            sql_p_color = """SELECT color FROM p_color"""
        ...
        with conn.cursor() as cursor:
            ...
            sql_p_brand = """SELECT brand FROM p_brand"""
        ...
        with conn.cursor() as cursor:
            ...
            sql_p_type = """SELECT type FROM p_type"""
        ...
        with conn.cursor() as cursor:
            ...
            sql_product = """SELECT product.pid, product.name, p_color.color, p_brand.brand, p_type.type
                      FROM product
                      LEFT JOIN p_color ON product.cid = p_color.cid
                      LEFT JOIN p_brand ON product.bid = p_brand.bid
                      LEFT JOIN p_type ON product.tid = p_type.tid
